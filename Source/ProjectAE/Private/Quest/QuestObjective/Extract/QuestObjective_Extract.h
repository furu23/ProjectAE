...
#include "QuestObjective_Extract.generated.h"

class UObjectiveConfig_Extract;

/**
 * 
 */
UCLASS()
class UQuestObjective_Extract : public UQuestObjective
{
	GENERATED_BODY()
...
protected:
	...
	const UObjectiveConfig_Extract* ExtractConfig;
};
